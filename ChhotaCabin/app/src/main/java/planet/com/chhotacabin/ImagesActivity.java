...
import planet.com.chhotacabin.multipleImg.ImageAdapter;
import planet.com.chhotacabin.multipleImg.ImageModel;
import planet.com.chhotacabin.multipleImg.SelectedImageAdapter;
        ...
        imageList = new ArrayList<>();
            ...
            public void onClick(View v) {
               ...
               /* for (int i = 0; i < selectedImageList.size(); i++) {
                    ...
                    Log.e("imgName",">>>" +selectedImageList.get(i));
                }*/

                    if (selectedImageList.size() == 0) {
                        Toast.makeText(ImagesActivity.this, "Please Select image", Toast.LENGTH_SHORT).show();
                    } else {
                        Intent in = new Intent(ImagesActivity.this, Owner_detail_vender2.class);
                        startActivity(in);
